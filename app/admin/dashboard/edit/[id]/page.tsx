...
import { isAdminAuthenticated, getBusinessById, updateBusiness, getCategoriesWithCounts } from '@/lib/storage';
...
export default function EditBusinessPage() {
    ...
    useEffect(() => {
        ...
        if (business.coverImage) {
            setImagePreview(business.coverImage);
        }
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        updateBusiness(businessId, {
            ...
            location: {
                latitude: 12.9716, // Keep existing or default
                longitude: 77.5946,
                city: formData.city,
            },
